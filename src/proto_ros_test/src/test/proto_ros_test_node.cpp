...
int main(int argc, char **argv)
{
    ...
    else
    {
        ...
        std::cout << "de_obstacles_info->set_is_tracker:" << de_obstacles_info.is_tracker() << " de_obstacle_info->set_point3:" << de_obstacles_info.point3f().x() << std::endl;
    }
    ...
    else
    {
        ...
        std::cout << " size of perceptron:" << deserialized_frame_array.perceptron_size() << " deserialized_frame_array->object_width:" << deserialized_frame_array.perceptron(deserialized_frame_array.perceptron_size() - 1).target_size().object_width() << std::endl;
    }
